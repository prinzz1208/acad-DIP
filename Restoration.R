...
# grayscaleImg=(grayscale(resize(Img,400,400)))
plot(Img)
Img
m=imnoise(as.matrix(RGB2gray(Img)),type = "saltnpepper",L=255)
# m=imnoise(as.matrix(grayscaleImg))
plot(as.cimg(m))
#meanFilter
filter=matrix(1,3,3)
mFil=nrow(filter)
